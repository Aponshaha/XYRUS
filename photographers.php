...
<div class="wrapper">
  ...
  <header class="main-header" style="opacity:.8">
    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          ...
          <h1 class="text-center" style="background: -webkit-linear-gradient(#e12126, #e4373c);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;opacity:.7">Find Your Photographers<br/><br/></h1>  
            <div class="input-group input-group-lg">
                <input type="text" id="searchBar" class="form-control" placeholder="Search Photographers"style="opacity:.6">
    ...
    <section id="candidates" class="content-header"style="opacity:.8">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="" class="citySearch" data-target="Sylhet"><i class="fa fa-circle-o text-yellow"></i> Sylhet</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
                    <a href="#"><i class="fa fa-plane text-red"></i> Country <span class="pull-right"><i class="fa fa-angle-down pull-right"></i></span></a>
                    <ul class="treeview-menu">
                      <li><a href="" class="experienceSearch" data-target="Bangladesh"><i class="fa fa-circle-o text-yellow"></i> Bangladesh</a></li>
                      <li><a href="" class="experienceSearch" data-target='India'><i class="fa fa-circle-o text-yellow"></i> India</a></li>
	      ...
	      {    $limit = 4;
	          ...
	          $sql = "SELECT COUNT(id_company) AS id FROM photographers";
  ...
  <footer class="main-footer" style="margin-left: 0px;opacity:.8">
    <div class="text-center">
